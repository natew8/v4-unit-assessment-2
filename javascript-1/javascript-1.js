...
//CODE HERE
  let phone1 = new Phone('apple', 'iphone15', 250, 'gunmetal', false)
  
  let phone2 = new Phone('apple', 'iphone11+', 64, 'white', false)
  
  let phone3 = new Phone('android', 'busted', 0, 'lame', false)
...
// this[key] = true && `${this.brand}${this.model} has been sold.`